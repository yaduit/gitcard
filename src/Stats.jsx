...
export default function Stats({userData}) {
  return (
    <div className='grid grid-cols-2 gap-6 border border-gray-300 shadow-lg bg-white rounded-lg p-6 mx-auto w-fit max-w-md'>
      ...
      <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
        ...
        <div>
          ...
          <span className='text-xl font-semibold text-gray-800'>{userData?.public_gists ||"Loading..."}</span>
        </div>
      </div>
      ...
      <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
        ...
        <div>
          ...
          <span className='text-xl font-semibold text-gray-800'>4</span>
        </div>
      </div>
