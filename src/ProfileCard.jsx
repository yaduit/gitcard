...
export default function ProfileCard({ userData }) {
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center md:items-start justify-start gap-4 mt-2 rounded-xl w-full border border-gray-300 shadow-sm hover:shadow-md transition-all duration-200 bg-white p-6 max-w-[650px] mx-auto overflow-hidden">
